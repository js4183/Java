...
public class Pocketmon {
	...
	// 1. 이름(String), 속성(String), 레벨(int), 체력(int), 공격력(int) ->포켓몬의 속성
	...
	// 3. 생성자 메소드는 오버로딩이 가능하다(중복 정의)
	// 4. 객체 생성시 new 키워드와 함께 호출된다.

//	public Pocketmon(String name, String type, int lv, int hp, int ak) {
//		this.name = name;
//		this.type = type;
//		this.lv = lv;
//		this.hp = hp;
